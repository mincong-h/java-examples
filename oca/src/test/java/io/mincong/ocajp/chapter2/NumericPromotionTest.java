 ...
 *   <li>Smaller data types, namely {@code byte}, {@code short}, and {@code char}, are first
 *       promoted to {@code int} any time they're used with a Java arithmetic chapter2, even if
 *       neither of the operands is {@code int}.
