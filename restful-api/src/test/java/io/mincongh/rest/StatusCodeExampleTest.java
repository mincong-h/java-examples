...
class StatusCodeExampleTest {
  ...
  /**
   * HTTP status code 200 - "OK" means the request is okay, entity body contains requested resource.
   */
  @Test
  void getCode200_ok() throws Exception {
  ...
  /**
   * HTTP status code 400 - "Bad Request" is used to tell the client that it has sent a malformed
   * request.
   */
  @Test
  void getCode400_badRequest() throws Exception {
  ...
  /**
   * HTTP status code 415 - "Unsupported Media Type" is used when a client sends an entity of a
   * content type that the server does not understand or support.
   */
  @Test
  void getCode415_notAcceptable() throws Exception {
