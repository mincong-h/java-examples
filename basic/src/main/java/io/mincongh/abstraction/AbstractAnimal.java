...
/**
 * An abstract class is a class which cannot be instantiated. An abstract class
 * is used by creating an inheriting subclass that can be instantiated. An
 * abstract class does a few things for the inheriting subclass:
 * <ul>
