...
public class DateConversionTest {
  ...
  public void testIso8601AndRfc822() throws ParseException {
    ...
    final long timestamp = 1299758070207L;
    ...
    assertEquals(timestamp - 3600 * 1000L, rfc822.parse("2011-03-10T11:54:30.207+0100").getTime());
    assertEquals(timestamp - 3600 * 1000L, iso8601S.parse("2011-03-10T11:54:30.207+01").getTime());
    assertEquals(timestamp - 3600 * 1000L, iso8601M.parse("2011-03-10T11:54:30.207+0100").getTime());
    assertEquals(timestamp - 3600 * 1000L, iso8601L.parse("2011-03-10T11:54:30.207+01:00").getTime());
  }
}
